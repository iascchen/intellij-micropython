...
from esp32board import Pyboard
from esp32files import Files, DirectoryExistsError
...
def main(args: List[str]) -> None:
    print("In Esp32upload", file=sys.stderr)
...
def soft_reset(board: Pyboard) -> None:
    ...
    data = board.read_until(1, b'PYB: soft reboot\r\n')
    print("Esp32upload Return", data, file=sys.stderr)
