...
class Pyboard:
    ...
    def read_until(self, min_num_bytes, ending, timeout=10, data_consumer=None):
        ...
        # print('read_until = ', data, file=sys.stderr, flush=True)
    ...
    def enter_raw_repl(self):
        print("In Esp32board enter_raw_repl", file=sys.stderr, flush=True)
    ...
    def exit_raw_repl(self):
        ...
        # print("In exit_raw_repl", data, file=sys.stderr, flush=True)
